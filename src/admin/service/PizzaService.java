...
import admin.repository.in_memory.PizzaInMemoryRepository;
...
public class PizzaService {
    ...
    private final PizzaInMemoryRepository pizzaInMemoryRepository = PizzaInMemoryRepository.getInstance();
